...
function handleHeader() {
    ...
    self.bind('click', function () {
        ...
        $('form#font-settings').show();
        storeValues(self, fontcolor, text, fontsize, fontfamily, background, $('#selector'));
        showSettings();
                ...
                switch (t) {
                    case 'title':
                        ...
                        titolo.bind('click', function (e) {
                            ...
                            storeValues(self, fontcolor, text, fontsize, fontfamily, background, this);
                    ...
                    case 'text-block' :
                        ...
                        $('#' + $('#path').val()).find('p').addClass('selected-item');
                        ...
                        $('form#font-settings').show();
                        $('form#editor').show();
                        storeValues(self, fontcolor, text, fontsize, fontfamily, background, $('#' + $('#path').val()).find('p'));
                        break;
                    ...
                    case 'imgtxtcol':
                        ...
                        textElement.bind('click', function () {
                            ...
                            var background = $('#' + $('#path').val()).css('background-color');
                            $('#selector').val('tbody tr td p');
                            storeValues($('#' + $('#path').val()), fontcolor, text, fontsize, fontfamily, background, textElement);
                    ...
                    case 'imgtxtincol':
                        ...
                        textElement.each(function (index) {
                            ...
                            $(this).bind('click', function () {
                                ...
                                var fontfamily = $(this).css('font-family');
                                var background = $('#' + $('#path').val()).css('background-color');
                                storeValues($('#' + $('#path').val()), fontcolor, text, fontsize, fontfamily, background, this);
                    ...
                    case 'imgtxt':
                        ...
                        */
                        ...
                        titleElement.bind('click', function () {
                            ...
                            storeValues($('#' + $('#path').val()), fontcolor, text, fontsize, fontfamily, background, titleElement);
                        });
...
function storeValues(obj, fontcolor, text, fontsize, fontfamily, background, element) {
    tinymce.remove();
    var textValue = document.querySelector('.selected-item').outerHTML;
    var text = textValue.replaceAll('selected-item','');
    text = text.replaceAll('class=""','');
    text = text.replaceAll('border: 1px dotted red;','');
    tinymce.init({
        selector: 'textarea#html5editor',
        setup: function (editor) {
            ...
            editor.on('keyup', function(e) {
                $('.selected-item').html(tinymce.get("html5editor").getContent({ format: "html" }));
            });
    ...
    tinymce.init({
        selector: 'textarea#html5editorlite',
        setup: function (editor) {
            ...
            editor.on('keyup', function(e) {
                $('.selected-item').html(tinymce.get("html5editorlite").getContent({ format: "html" }));
            });
            editor.on('change', function(e) {
                $('.selected-item').html(tinymce.get("html5editorlite").getContent({ format: "html" }));
            });
