!function() {
  ...
  Calendar.prototype.renderEvents = function(events, ele) {
    ...
    events.forEach(function(ev) {
      ...
      var anchor = createLinkElement('a', 'spotLink', ev.spotLink, ev.eventName);
  ...
  function createLinkElement(tagName, className, href, innerText) {
    var ele = document.createElement(tagName);
    if(className) {
      ele.className = className;
    }
