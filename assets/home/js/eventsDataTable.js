        ...
        columns: [
            ...
            },
            {
                ...
                "render": function(data, type, row) {
                    ...
                    var edit_btn = '<div style="display: flex; width: 120px;"><a class="text-primary" href="'+globalVariables.baseUrl+'events/edit/'+data.id+'">'+edit_svg+'</a>';
                    var guestlist = '<a class="ml-3 text-primary" style="font-size: 19px;" href="'+globalVariables.baseUrl+'events/guestlist/'+data.id+'"><i class="fa fa-users" aria-hidden="true"></i></a>'
                    var arrow_right = '<a class="ml-3 text-dark" href="'+globalVariables.baseUrl+'events/event/'+data.id+'">'+arrow_svg+'</i></a></div>';
                    return edit_btn + ' ' + guestlist + ' ' + arrow_right;
                }
