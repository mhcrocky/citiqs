...
$route['dashboard/agenda'] = "customer_panel/agenda";
$route['dashboard/spots/(:num)'] = "customer_panel/spots/$1";
$route['dashboard/time_slots/(:num)'] = "customer_panel/time_slots/$1";
