...
switch (strtolower($_SERVER['HTTP_HOST']))
{
	case 'tiqs.com':
		...
		define('USERNAME', 'tiqs_alfreduser');
		define('PASSWORD', '2LzcV1etVv');
...
CONST THGROUP = '1162';
CONST JWT_KEY = 'qwertzui';

CONST VENDOR_NO_UPDATE = '9166';
...
defined('VISMA_redirect')      OR define('VISMA_redirect', 'https://tiqs.com/alfred/visma');
