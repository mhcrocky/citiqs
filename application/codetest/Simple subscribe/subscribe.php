<?php 
	...
	$your_installation_url = 'https://tiqs.com/newsletters'; //Your Sendy installation (without the trailing slash)
	$list = 'QdwSPHHTusWixZHWNhLqgw'; //Can be retrieved from "View all lists" page
