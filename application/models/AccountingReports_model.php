...
class AccountingReports_model extends CI_Model
{
	...
	{
		$query = $this->db->query("SELECT tbl_shop_orders.id AS order_id,tbl_shop_orders.export_ID, date(tbl_shop_orders.created) AS order_date,tbl_shop_products_extended.deliveryVatpercentage AS productVat,tbl_shop_products_extended.`name` AS productName,tbl_shop_products_extended.price,
	...
	{
		$query = $this->db->query("SELECT tbl_shop_orders.id AS order_id,tbl_shop_orders.export_ID, date(tbl_shop_orders.created) AS order_date,tbl_shop_products_extended.pickupVatpercentage AS productVat,tbl_shop_products_extended.`name` AS productName,tbl_shop_products_extended.price,
					tbl_shop_order_extended.quantity,
