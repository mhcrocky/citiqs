...
//				die();
	...
	{
		$query = $this->db->query("SELECT id, eventdate, voucher, reservationId, reservationtime, price, numberofpersons, name, email, mobilephone, Spotlabel, timefrom, timeto, TransactionID
		FROM tbl_bookandpay
