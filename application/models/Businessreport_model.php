...
class Businessreport_model extends CI_Model {
	...
	{
		$query = $this->db->query("SELECT tbl_shop_orders.id AS order_id, tbl_shop_vendors.serviceFeeTax as vendor_serviceFeeTax, tbl_shop_orders.updated AS order_date, tbl_shop_products_extended.vatpercentage AS productVat,tbl_shop_products_extended.`name` AS productName,tbl_shop_products_extended.price,tbl_shop_order_extended.quantity,
...
WHERE vendor.id = '418' AND tbl_shop_orders.paid = '1' AND serviceTypeId = '1'");
