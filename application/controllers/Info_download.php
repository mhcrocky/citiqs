...
class info_download extends BaseControllerWeb
{
	/**
	...
	public function index()
	{
		...
		$this->loadViews("info_download", $this->global, $data, NULL);
	}
...
//		$this->form_validation->set_rules('user_message','Description','trim|required|max_length[128]');
		...
		if ($this->form_validation->run()) {
			...
			switch (strtolower($_SERVER['HTTP_HOST'])) {
				case 'tiqs.com':
					$file = '/home/tiqs/domains/tiqs.com/public_html/lostandfound/assets/home/documents/' ;
					break;
				case '127.0.0.1':
					$file = '/Users/peterroos/www/lostandfound/assets/home/documents/';
					break;
				default:
					break;
			}
