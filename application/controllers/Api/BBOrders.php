<?php
    ...
    class BBOrders extends REST_Controller
    {
        ...
        function __construct()
        {
            ...
            $this->load->model('Shoporderbb_model',"shoporder_model");
        ...
        */
        ...
        private function VatnoVatdata($order,$vatzeroflag=0)
        {
            ...
            $this->drawreciept= base_url() . 'receipts/'.$img__filename . '.png';
        ...
        public function getdraw_get()
        {
            ...
            // $order = $this->shoporder_model->fetchOrdersForPrint($get['mac']);
            $order = $this->shoporder_model->fetchOrdersForPrint($get['mac'],'tbl_shop_order_extended.drawprinted = "0" ');
            if (!$order) return;
            $order = reset($order);
