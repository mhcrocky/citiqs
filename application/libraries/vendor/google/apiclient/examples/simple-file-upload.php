...
<?php elseif($_SERVER['REQUEST_METHOD'] == 'POST'): ?>
  <div class="shortened">
    ...
    <ul>
      <li><a href="https://drive.google.com/open?id=<?php $result->id ?>" target="_blank"><?php $result->name ?></a></li>
      <li><a href="https://drive.google.com/open?id=<?php $result2->id ?>" target="_blank"><?php $result2->name ?></a></li>
    </ul>
  </div>
<?php else: ?>
  <form method="POST">
