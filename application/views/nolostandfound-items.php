...
<div class="main-wrapper">
		...
		<div class="flex-column align-start width-650">
			<div align="left" >
				...
				<div class="width-650">
					...
					<h2 style="color:#ffffff; margin-bottom: 30px"  class="heading"><?=$this->language->line("NOFOUND-101010",'WE ARE SORRY,');?></h2>
					<div >
						<p id="UnkownAddressText" style="font-family:'caption-light'; font-size:100%; color:#ffffff;  text-align: left">
							<?=$this->language->line("NOFOUND-25551",'THERE ARE NO FOUND ITEMS REGISTERED ON THIS LOCATION, WE HAVE LOOKED BUT WE COULD NOT FIND ANY....')?>
							<?=$this->language->line("NOFOUND-15560",'
                                ...
                                ');?>
							<br/><br/>
							<?=$this->language->line("NOFOUND-25560",'
					...
					<div align="center" >
						<a href="<?php echo base_url(); ?>check" class="button button-orange mb-35"><?=$this->language->line("NOFOUND-10280",'REGISTER YOUR LOST ITEM');?></a>
	...
	<div class="col-half background-yellow" align="left">
		<div class="background-yellow">
			<div class="width-650">
				<!--        HERE THE UPLOAD ID SCREEN-->
				<h2 style="color:#ffffff; margin-bottom: 30px"  class="heading"><?=$this->language->line("NOFOUND-1101010",'GET EXTRA TIQS-TAGS-STICKERS FOR YOUR FRIENDS AND RELATIVES');?></h2>
				<div >
					<p id="UnkownAddressText" style="font-family:'caption-light'; font-size:100%; color:#ffffff;  text-align: left">
						<?=$this->language->line("NOFOUND-15550",'WE APPRECIATE YOUR EFFORT!')?>
						<?=$this->language->line("NOFOUND-15560",'
				...
				<div align="center" >
					<a href="<?php echo base_url(); ?>check" class="button button-orange mb-35"><?=$this->language->line("NOFOUND-1130280",'GET YOUR EXTRA STICKERS');?></a>

				</div>
				<p style="color:#ffffff" class="text-content mb-50"><?=$this->language->line("ITEMFOUND-1111110",'lost by you, <br> returned by us');?></p>
			</div>
		</div>
