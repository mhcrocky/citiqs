...
<div class="main-wrapper">
	...
	<div class="col-half background-yellow">
		<div class="background-orange-light height">
			<div class="width-650">
				<h2 class="heading mb-35"><?php $this->language->line("CODE-250",'<a href="https://tiqs.com/lostandfound/personaltagsinfo">GET YOUR FREE TIQS <br>PERSONAL LOST + FOUND<br>STICKERS</a>');?></h2>
				...
				<a style="color:#ffffff" class='how-we-works-link' href="<?php echo base_url(); ?>howitworksconsumer"><?php $this->language->line("CODE-260",'MORE INFO, HOE IT WORKS');?></a>
				<p class="text-content mb-50"><?php $this->language->line("CODE-70",'LOST BY YOU, <br> RETURNED BY US');?></p>
				<a href="<?php echo base_url(); ?>check" class="button button-orange mb-35"><?php $this->language->line("CODE-280",'ORDER YOUR FREE STICKERS');?></a>
			</div>
	...
	<div class="background-yellow height-50">
		<div class="width-650">
			<h2 class="heading mb-35"><?php $this->language->line("CODE-251",'BECOME A TIQS AMBASSADOR.');?></h2>
			...
			<form action="<?php echo base_url(); ?>loginMe" method="post" class='homepage-form'>
				<form action="<?php echo base_url(); ?>checkregister" method="post">
					<div class="form-group has-feedback">
						<input type="email" id="email" class="form-control" style="font-family:'caption-light'; border-radius: 50px; " placeholder="<?php $this->language->line("CODE-252",'Your e-mail');?>" id="brandemail" name="email" onfocusout="myFunctionBrand(this.value)" required />
					</div>
					...
					<p id="brandUnkownAddressText" style="font-family:'caption-light'; margin-bottom: 10px; display:none; font-size:100%; color:#ffffff;  text-align: left" >
						<?php $this->language->line("CODE-290",'THANKS, FOR YOUR APPLICATION AS BRAND AMBASSADOR FOR SUPPORTING TO THE WORLD LARGEST HONEST LOST AND FOUND COMMUNITY!')?>
						<?php $this->language->line("CODE-300",'
					...
					<div class="form-group has-feedback">
						<input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CODE-310",'Your full name');?>" id="brandname" name="name"  />
					</div>

					<div class="form-group has-feedback">
						<input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CODE-320",'Your address');?>" id="brandaddress" name="address"  />
					</div>

					<div class="form-group has-feedback">
						<input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CODE-330",'Extra address line');?>" id="brandaddressa" name="addressa"  />
					</div>

					<div class="form-group has-feedback">
						<input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CODE-340",'Your zipcode');?>" id="brandzipcode" name="zipcode" />
					</div>

					<div class="form-group has-feedback">
						<input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CODE-350",'City');?>" id="city" name="brandcity"  />
					...
					<div class="selectWrapper" style="display: none" id="brandcountry1">
						...
						<option value="">
							<?php $this->language->line("CODE-360","Select your country");?>
						</option>
					...
					<div class="form-group has-feedback" >
						<div style="text-align: center; margin-bottom: 30px ">
							<input type="submit" class="button button-orange" value="<?php $this->language->line("CODE-370",'APPLY');?>" style="border: none" />
						</div>
					</div>
