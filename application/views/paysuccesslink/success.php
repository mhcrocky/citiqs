		...
		<svg xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
			<defs>
				...
				<g id="tree">
					...
					<g opacity="0.4">
						<path fill="#bad592" d="M1085.2 552.4c-29.4 14.7-49.5 45-49.5 80.1 0 49.4 40.1 89.5 89.5 89.5 49.4 0 89.5-40.1 89.5-89.5 0-35.2-20.3-65.6-49.8-80.2"/>
						<path fill="#bad592" d="M1164.9 552.3c10-10.1 16.1-24 16.1-39.3 0-30.9-25.1-56-56-56s-56 25.1-56 56c0 15.4 6.2 29.3 16.2 39.4"/>
						<path fill="#bad592" d="M1153.9 561c4-2.4 7.7-5.4 11-8.7"/>
						<path fill="#bad592" d="M1104.3 545.5c-6.7 1.6-13.1 3.9-19.1 7"/>
					</g>
				...
				<g id="cat">
					...
					<path fill="#FFF" stroke="#375068" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1097.1 612.3c0 0-4.5-9.3-0.3-17.7 0 0 4.5 5.6 9.3 7"/>
					<path fill="#FFF" stroke="#375068" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1140.6 612.3c0 0 4.5-9.3 0.3-17.7 0 0-4.5 5.6-9.3 7"/>
					<circle fill="#FFF" stroke="#375068" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" cx="1118.6" cy="621.7" r="23.1"/>
					<path fill="#ED4F43" d="M1122.4 625c0 5.3-1.4 6.3-3.8 6.3 -2.4 0-3.8-1-3.8-6.3"/>
					<path fill="#FFF" stroke="#375068" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1132.8 621.2c0 3.9-3.2 7-7 7s-7-3.2-7-7h-0.2c0 3.9-3.2 7-7 7s-7-3.2-7-7"/>
					<path fill="#FFF" stroke="#375068" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1104.7 613c0 0 0-3.1 2.8-3.8 2.9-0.8 4.2 1.7 4.2 1.7"/>
					<path fill="#FFF" stroke="#375068" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1132.6 613c0 0 0-3.1-2.8-3.8 -2.9-0.8-4.2 1.7-4.2 1.7"/>
...
<!--				</g>-->
				...
				<g id="plane">
					...
					<text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family='Fredoka One' font-size="34" fill="#0170BB"> Prepairing your order  </text>
			...
			<g id="toldo">
				...
				<path opacity="0.4" fill="#f15a25" d="M467.3 392.1h73.4l-14 79.5c0 22.7-18.4 41-41 41 -22.7 0-41-18.4-41-41L467.3 392.1z"/>
				<path opacity="0.4" fill="#f15a25" d="M615.7 392.1H690l3.5 79.5c0 22.7-18.4 41-41 41 -22.7 0-41-18.4-41-41L615.7 392.1z"/>
				<path opacity="0.4" fill="#f15a25" d="M765.1 392.1h73.4l21.8 79.5c0 22.7-18.4 41-41 41s-41-18.4-41-41L765.1 392.1z"/>
				<path opacity="0.4" fill="#f15a25" d="M913.6 392.1h73.4l40.2 79.5c0 22.7-18.4 41-41 41 -22.7 0-41-18.4-41-41L913.6 392.1z"/>
				<path opacity="0.4" fill="#f15a25" d="M317.9 392.1h73.4l-31.4 79.5c0 22.7-18.4 41-41 41 -22.7 0-41-18.4-41-41L317.9 392.1z"/>
			...
			<g id="door">
				...
				<g id="sign">
					...
					<text transform="matrix(1.0027 0 0 1 789.6294 721.7501)" fill="#FFF" font-family='Fredoka One' font-size="38"> BUSY </text>
			...
			<rect class="grass" x="130" y="850" fill="#138575" width="100%" height="80"></rect>
		</svg>
	</div>
</div>
	<h2>CONFIRMATION</h2>
	...
	<div class="checkout-message__content">
        ...
        <?php } ?>
		<h3 class='order-status order-status--true'>We are now working on your order</h3>
	</div>
	<div class="checkout-btns">
        <?php if (isset($order)) { ?>
            <a
