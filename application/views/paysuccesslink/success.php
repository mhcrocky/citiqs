...
<div class='checkout-message' style='margin-top: 100px; margin-bottom: 100px;'>
	...
	<div class="checkout-message__content">
        ...
        <p class='order-status order-status--true'><?php echo $this->language->tLine('successful'); ?></p>
        <?php if (isset($order)) { ?>
        ...
        <?php } ?>
		<h3 class='order-status order-status--true'><?php echo $this->language->tLine('We are now working on your order'); ?></h3>
	</div>
	<div class="checkout-btns">
        <?php if (isset($order)) { ?>
            <a
