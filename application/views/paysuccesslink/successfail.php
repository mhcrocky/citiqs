...
<div class='checkout-message' style='margin-top: 100px; margin-bottom: 100px;' >
	...
	<div class="checkout-message__content">
        ...
        <p class='order-status order-status--true'><?php echo $this->language->tLine('not processed'); ?></p>
        <?php if (isset($order)) { ?>
        ...
        <?php } ?>
		<h3 class='order-status order-status--true'>
            <?php echo $this->language->tLine('An inactive payment methode was chosen, please select another payment type'); ?>
        </h3>
	</div>
	<div class="checkout-btns">
        <?php if (isset($order)) { ?>
            <a
                ...
                class="button"
            >
                <?php echo $this->language->tLine('Order again'); ?><i class="fa fa-arrow-right"></i>
            </a>
        <?php } else { ?>
