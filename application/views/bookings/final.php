            ...
            <div class="login-box background-orange-light">
                ...
                <div class="pricing-first" style="font-family: caption-bold ;margin-left: 30px;margin-right: 30px">
                    ...
                    <p style="font-family: caption-light">
                        1. <?php echo ($this->language->Line("FINAL-0014", "RESERVATION CREDITS / DEPOSIT (NO RENT OF BEDS AND ROOF TERRACE) EXCLUSIVE RESERVATION / BOOKING FEE WILL BE PAID INTO YOUR ACCOUNT WITHIN 2-3 BUSINESS DAYS AFTER SCANNING OF THE RESERVATION AT THE ENTRANCE.")) ? $this->language->Line("FINAL-0014", "RESERVATION CREDITS / DEPOSIT (NO RENT OF BEDS AND ROOF TERRACE) EXCLUSIVE RESERVATION / BOOKING FEE WILL BE PAID INTO YOUR ACCOUNT WITHIN 2-3 BUSINESS DAYS AFTER SCANNING OF THE RESERVATION AT THE ENTRANCE.") : "RESERVATION CREDITS / DEPOSIT (NO RENT OF BEDS AND ROOF TERRACE) EXCLUSIVE RESERVATION / BOOKING FEE WILL BE PAID INTO YOUR ACCOUNT WITHIN 2-3 BUSINESS DAYS AFTER SCANNING OF THE RESERVATION AT THE ENTRANCE."; ?></p>
                    <p style="font-family: caption-light">
                        2. <?php echo ($this->language->Line("FINAL-0015", "A RESERVATION CANNOT BE CANCELED BUT IT CAN BE CONVERSED AT THE LATEST 48 HOURS BEFORE THE BEGINNING OF THE BOOKED RESERVATION TIME.")) ? $this->language->Line("FINAL-0015", "A RESERVATION CANNOT BE CANCELED BUT IT CAN BE CONVERSED AT THE LATEST 48 HOURS BEFORE THE BEGINNING OF THE BOOKED RESERVATION TIME.") : "A RESERVATION CANNOT BE CANCELED BUT IT CAN BE CONVERSED AT THE LATEST 48 HOURS BEFORE THE BEGINNING OF THE BOOKED RESERVATION TIME."; ?></p>
                    <p style="font-family: caption-light">
                        3. <?php echo ($this->language->Line("FINAL-0016", "YOU CAN CHANGE BY MAKING A NEW RESERVATION, SEND YOUR OLD RESERVATION TO SUPPORT@TIQS.COM. THE RESERVE AMOUNT OF YOUR OLD RESERVATION (IF NOT CONVERSED WITHIN 48 HOURS) WILL BE PAID BACK EXCLUSIVE OF THE PAID RESERVATION / BOOKING FEE.")) ? $this->language->Line("FINAL-0016", "YOU CAN CHANGE BY MAKING A NEW RESERVATION, SEND YOUR OLD RESERVATION TO SUPPORT@TIQS.COM. THE RESERVE AMOUNT OF YOUR OLD RESERVATION (IF NOT CONVERSED WITHIN 48 HOURS) WILL BE PAID BACK EXCLUSIVE OF THE PAID RESERVATION / BOOKING FEE.") : "YOU CAN CHANGE BY MAKING A NEW RESERVATION, SEND YOUR OLD RESERVATION TO SUPPORT@TIQS.COM. THE RESERVE AMOUNT OF YOUR OLD RESERVATION (IF NOT CONVERSED WITHIN 48 HOURS) WILL BE PAID BACK EXCLUSIVE OF THE PAID RESERVATION / BOOKING FEE."; ?></p>
                </div>
                <div class="pricing-block-footer" style="height: 200px">
                    <button data-brackets-id="2918" type="submit"
                            class="button button-orange">
                            <?php echo ($this->language->Line("FINAL-0017", "PAY")) ? $this->language->Line("FINAL-0017", "PAY") : "PAY"; ?>
                    </button>
                </div>
