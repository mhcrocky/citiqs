...
<main class="row" style="margin:0px 20px">
                ...
                <tbody>
                    ...
                    if ($vat_rates) {
                        foreach ($vat_rates as $l) { ?>
                            <tr>
                                <td><a href="<?php echo base_url(); ?>setting/visma/vat/<?php echo $l->id ?>">[<?php echo $l->vat_external_code ; ?>] <?php echo $l->rate_desc; ?></a></td>
                                <td class="w80 text-right"><a href="<?php echo base_url(); ?>setting/visma/vat/<?php echo $l->id ?>" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></a> <a href="<?php echo base_url(); ?>setting/visma/vat_delete/<?php echo $l->id; ?>" class="btn btn-default btn-xs delete"><i class="fa fa-trash"></i></a></button></td>
                            </tr>
                    <?php }
                    } ?>
                </tbody>
    ...
    <div class="col-lg-6 col-sm-12">
        <div class="card" style="background-color:#138575">
            <div class="card-body setting-card-body pb-0">
                <a href="<?php echo base_url('setting/visma/vat'); ?>" type="button" class="btn btn-success setting-btn" data-card-widget="collapse" data-toggle="tooltip" title="Add">Add</a>
                <p class="lead text-white setting-lead">Setting</p>
            </div>
        </div>
        <?php echo form_open('setting/visma_vatrate/save') . "\r\n"; ?>
        ...
        <div class="form-group">
            <label for="vat_external_code">Visma VAT% Ledgers</label>
            <select name="vat_external_code" id="vat_external_code" class="form-control">
                <option value="" selected="selected">--- select Visma VAT account ---</option>
                <?php
                ...
                ?>
                        <option value="<?php echo trim($parts[0]) ?>"><?php echo $parts[1] ?></option>
                <?php  }
                } ?>
            </select>
        </div>
