		...
		<div class="flex-column align-start "><!-- width-650 -->
			<div style="text-align:left; font-family: caption-light">
				...
				<form action="<?php echo base_url(); ?>payregisterandpaysubscription" method="post">
					...
					<div class="form-group has-feedback">
						<input type="tel" id="mobile" name="user[mobile]" disabled  class="form-control" style="display: none; font-family:'caption-light'; border-radius: 50px;" placeholder="<?php $this->language->line("SEND-160",'Your mobile number');?>" />
					</div>
					<div class="form-group has-feedback">
						<input id="username" disabled type="text" name="user[username]" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-070",'Your full name');?>" />
					</div>
					<div class="form-group has-feedback">
						<input id="address" disabled type="text" name="user[address]" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-080",'Your address');?>" />
					</div>
					<div class="form-group has-feedback">
						<input id="addressa" disabled type="text" name="user[addressa]" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-090",'Extra address line');?>" />
					</div>
					<div class="form-group has-feedback">
						<input type="text" id="zipcode" name="user[zipcode]" disabled class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-100",'Your zipcode');?>" />
					</div>
					<div class="form-group has-feedback">
						<input type="text" id="city" disabled  name="user[city]" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-110",'City');?>" />
					</div>
					<div class="form-group has-feedback">
