		...
		<div class="flex-column align-start">
			<div  style="text-align:center">
				<h2 class="heading mb-35">
					<?=$this->language->line('CHECKOUT-A10001','GET YOUR ITEM BACK PROCESS</a>');?>
				</h2>
				<h3 class="heading mb-35 text-blue-dark">
					<?=$this->language->line('CHECKOUT-C100010','FOLLOW THE 3 STEPS ON THIS SCREEN.');?>
				</h3>
				<p style="font-family: caption-light" class="text-content mb-35"><?=$this->language->line("CLAIMCHECKOUT-A003111",'LOST BY YOU,<br> RETURNED BY US.');?></p>

				<p style="font-family: caption-bold" class="text-content mb-35"><?=$this->language->line("CLAIMCHECKOUT-A00301",'YOU HAVE CLAIMED AN ITEM ON TIQS LOST AND FOUND. TO REPATRIATE THE ITEM BACK TO YOU, WE NEED TO PROCESS YOUR PAYMENT, ID AND UTILITY BILL (PROOF OF ADDRESS).
					');?></p>

				<p style="font-family: caption-light" class="text-content mb-35"><?=$this->language->line("CLAIMCHECKOUT-A00305",'
