	...
	<div class="col-half background-yankee height-100">
		<div class="flex-column align-start">
			...
			<form id="foundItem" action="<?php echo $this->baseUrl . $action; ?>" method="post" style="text-align:center;">
				...
				<div style="text-align:center;">
					...
					<?php if (!$code) { ?>
						<div style="text-align:center; font-family:caption-light; padding: 10px">
							<input type="text"  required name="code" class="form-control" placeholder="<?php $this->language->line("FOUND-01030",'Unique code from sticker or tag');?>" style="border-radius: 50px" />
						</div>
						<div style="text-align: center;">
							<a href=" <?php echo $this->baseUrl . 'itemfound'; ?>" class="button button-orange">
								<?php $this->language->line("FOUND-01032",'NO TAG? PLEASE MAKE A PICTURE');?>
							</a>
						</div>
					<?php } else { ?>
					<h2><?php echo $code; ?></h2>
				...
				<div style="font-family:caption-light; padding: 10px">
					<input type="email" id="email" name="email" required onblur="checkEmail(this)" class="form-control" style="font-family:'caption-light'; border-radius: 50px; " placeholder="<?php $this->language->line("FOUND-070",'Your e-mail');?>" />
				</div>
				<div style="font-family:caption-light; padding: 10px">
				...
				<div style="font-family:caption-light; padding: 10px;" id="label1">
					<input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("FOUND-090",'Name');?>" id="username" name="username" disabled />
				</div>
				<div style="font-family:caption-light; padding: 10px;" id="label2">
					<input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("FOUND-100",'Address');?>" id="address" name="address"  disabled />
				</div>
				<div style="font-family:caption-light; padding: 10px;" id="label3">
					<input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("FOUND-110",'Extra address line');?>" id="addressa" name="addressa"  disabled />
				</div>
				<div style="font-family:caption-light; padding: 10px;" id="label4" >
					<input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("FOUND-120",'Zipcode');?>" id="zipcode" name="zipcode" disabled />
				</div>
				<div style="font-family:caption-light; padding: 10px;" id="label5">
					<input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("FOUND-130",'City');?>" id="city" name="city" disabled />
				</div>
				...
				<div class="form-group has-feedback" style="padding: 30px;">
					<div style="text-align: center; ">
						<input type="button" onclick="checkValuesAndSubmit('foundItem', 'email', 'emailverify')"  class="button button-orange" value="<?php $this->language->line("FOUND-180",'SUBMIT FOUND ITEM');?>" style="border: none" />
					</div>
					<br>
				</div>
