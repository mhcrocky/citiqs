...
<div class="main-wrapper" align="center">
	<div class="col-half background-blue height-100">
		<div class="flex-column align-start width-650">
			<div align="center">
				<form action="info_download424/actiondownloadpdf" method="post" id="downloadForm" role="form">
					<h2 class="heading mb-35"><?=$this->language->line("DOWNLOADPDF-10000","DOWNLOAD YOUR DOCUMENT");?></h2>
					<div class="flex-row align-space">
						<div class="flex-column align-space width-650" style="font-family: caption-light">
							<div class="mb-35" style="font-family: caption-light">
								<p for="name">
									<?=$this->language->line("DOWNLOADPDF-10001","
									Name
									");?>
								</p>
								<div>
									<input type="text" class="form-control" id="name" name="name" style="border-radius: 50px; font-family: caption-light" placeholder="<?=$this->language->line("DOWNLOADPDF-10001","
									Name
									");?>" maxlength="128">
							...
							<div class="form-group has-feedback">
								<p for="phone">
									<?=$this->language->line("DOWNLOADPDF-10002","
									Phone
									");?>
									</p>
								<div class="form-group has-feedback">
									<input type="number" class="form-control" id="phone" style="border-radius: 50px; font-family: caption-light"  name="phone" placeholder="<?=$this->language->line("DOWNLOADPDF-10002","Phone
									");?>" maxlength="128">
							...
							<div class="form-group has-feedback">
								<p for="phone">
									<?=$this->language->line("DOWNLOADPDF-10003","
									E-mail Address
									");?>
								</p>
								<div class="form-group has-feedback">
									<input type="email" class="form-control" id="email" style="border-radius: 50px; font-family: caption-light"  name="email" placeholder="<?=$this->language->line("DOWNLOADPDF-10003","
									E-mail Address
									");?>" maxlength="128">
							...
							<div class="form-group has-feedback submit-form">
								<div>
									<input type="submit" class="button button-orange" value="<?=$this->language->line("DOWNLOADPDF-10004","SEND" );?>" style="border: none" class='button-submit'>
								</div>
							</div>
						</div>
					</div>
