...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajaxdorian/libs/axios/0.19.2/axios.min.js"></script>
    ...
    <div class="main-wrapper" style="text-align: center; display: block;">
        <div class="row container-fluid height-100 mx-auto">
            <div class="col-md-12 mx-auto" style="text-align:center; margin-bottom: 20px;">
                <a :href="baseURL+ 'customer_panel/spots/<?php echo $agendaId; ?>'" class="btn btn-primary">Back To Spots</a>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            ...
                            <search-select :options="spotsOptions"
                                           v-model="modalSpotId"
                                           placeholder="Select Spot"></search-select>
                        </div>

                        <div class="form-group">
                            <label for="timeslotdescript">Description</label>
                            <input type="text" name="timeslotdescript"
                                   v-model="timeSlotModalData.timeslotdescript" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="available_items"
                                   v-model="timeSlotModalData.available_items" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <search-select :options="emailsOptions"
                                           v-model="timeSlotModalData.email_id"
                                           placeholder="Select Email Template"></search-select>
                        </div>
                        <div class="form-group">
                            <label for="Price">Price</label>
                            <input type="number" step="0.01" name="Price"
                                   v-model="timeSlotModalData.price" class="form-control"
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            saveTimeSlot() {
                ...
                axios.post(this.baseURL + 'ajaxdorian/saveTimeSLot', formData
                ).then((response) => {
                    if (this.method == 'edit') {
            ...
            deleteTimeSlot() {
                ...
                axios.post(this.baseURL + 'ajaxdorian/deleteTimeSlot', formData
                ).then((response) => {
                    this.timeslots.splice(this.getIndexByID('timeslots', this.deleteTimeSlotTemp.id), 1);
        ...
        computed: {
            ...
            spotsOptions: function () {
                ...
                this.spots.forEach((spot) => {
                    spotsOptions.push({
                        value: spot.id,
                        text: spot.descript + ' ' + this.dateFormat(spot.ReservationDateTime)
                    });
                })
                return spotsOptions;
            },
