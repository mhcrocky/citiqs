...
<html>
  <head>
      <link rel="shortcut icon" href="https://tiqs.com/tiqsimg/tiqslogo.png" />
        <meta charset="UTF-8">
        <title>tiqs | Tag registered</title>
...
<div class="container">
    ...
    <div class="login-box">
        <div class="login-logo">
            <img border="0" src="<?php echo base_url(); ?>tiqsimg/lostandfoundregister.png" alt="tiqs" width="125" height="125" />
        ...
        <div class="login-box-body">
            ...
            <p  style="font-family:'Century Gothic W01'; font-size:300%; text-align: center">Tag registered</p>
            <?php
...
<!--            <a href="--><?php //echo base_url() ?><!--pay/1/--><?php //echo($email); ?><!--">-->
<!--                <input type="button" class="myButtonOrange" value="Pay subscription" />-->
<!--            </a>-->
<!--            </div>-->
            <?php
            }
...
<!--            check if paid already. -->
            ...
            <div>
                <p style="font-family:'Century Gothic W01'; font-size:100%; color: #ff5722; margin:20px,20px,20px,200px; text-align: center"><span>Subscribed!</span></p>
            </div>
            <p <br /></p>
            <div>
                <p style="font-family:'Century Gothic W01'; font-size:100%; color:#000000; margin:20px,20px,20px,200px; text-align: center">Thank you! Your next tag has been registered. <br> You already paid for your SMS subscriptions on the number given. <br> <br> If you want to change your mobile number or lost + found buddy mobile number, go to your personal settings in your dashboard.<br><br> You can register unlimited items with the tiqs tag and stickers. <br><br> You can login in to your account with the button below <br><br /></p>
            </div>
            <p <br /></p>

            <div class="social">
                <div class="or"><span>Login into your personal account!</span></div>
<!--                <a href="--><?php //echo base_url() ?><!--login/index">-->
<!--                    <input type="button" class="myButtonLightOrange" value="Go to homepage" />-->
<!--                </a>-->
<!--                Hier naar de volgende scan toe gaan ??? -->
                <a href="<?php echo base_url(); ?>login" >
                    <input type="button" class="myButtonLightOrange" value="Login" />
                </a>

            </div>
        </div><!-- /.login-box-body -->
        <a href="https://lostandfound.tips" ><font size="4" color="white">Back to menu</font></a><br>
    </div><!-- /.login-box -->
</div>
