			...
			<div class="card" style="text-align:center">
                ...
                <h2 class="heading">
                    ...
                    <div style="margin-bottom: 20px;">
						...
						<?php $this->language->line("CHECK424-1000101ABCDE",'COVID-19 GUEST REGISTRATION');?>
                        <?php if ($alreadyCheckIn) { ?>
						    <a href="<?php echo base_url()?>make_order?vendorid=<?php echo $vendor['vendorId']; ?>">"<?php $this->language->line("CHECK424-1234ABCDE",'ALREADY REGISTERED?, CLICK HERE');?>" </a>
                        <?php } ?>
                    </div>
                </h2>
                    ...
                    <div class="product background-orange active" style="width: 100%; height: 150%; text-align:center">
                        <div style="text-align:center">
                            ...
                            <ul style="list-style-type: none  ;font-family: caption-light; font-size:larger;  margin-left: -40px; margin-top: 20px; text-align:center">
								<?php $this->language->line("CHECK424-101200101ABCDEF",'TOGETHER WE KEEP OURSELVES SAFE.');?>
                            </ul>
							<div>
								<input
                                    type="radio"
    ...
    <div class="col-half background-yellow" id="info424">
        <div class="background-orange-light height">
            ...
            <ul style="list-style-type: none  ;font-family: caption-light; font-size:larger;  margin-left: -40px; text-align:left">
                ...
                <p><br></p>
                <li><?php $this->language->line("CHECK4241-41351232ABCDE",'YOU CAN HELP YOUR LOCAL BUSINESS BY PROVIDING THE ANSWERS IN A ELECTRICAL READABLE MANNER, ');?></li>
                <p><br></p>
            </ul>
