	...
	<div class="col-half  background-orange-light timeline-content">
		...
		<div class="login-box background-orange-light">
			...
			<div class="form-group has-feedback">
				<input type="text" id="username" name="username" required class="form-control" style="font-family:'caption-light'; border-radius: 50px;" placeholder="<?=$this->language->Line("spot-reservationspay-1300",'je naam');?>" />
			...
			<div class="form-group has-feedback">
				<input name="mobile" id="mobile" type="tel" class="form-control" style="font-family:'caption-light'; border-radius: 50px;" placeholder="<?=$this->language->Line("spot-resrevationpay-2200","je Phone number");?>" required />
