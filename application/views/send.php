		...
		<div class='col-testimonial-content'>
			...
			<div class="testimonial-row">
					...
					<div id="testimonials-wrapper" class="text">
						<div class="testimonial testimonial-layout-one">
							<div class="testimonial-section__text-wrapper">
								<p class="testimonial-section__text"><?php $this->language->line("SEND-AA000001","
				...
				<p class="text-content-light mb-35 mt-50" >
					<?php $this->language->line("SEND-A000100","
...
<div class="main-wrapper-nh">
	<div class="col-half background-yankee height-100">
		<div class="flex-column align-start">
			<div style="text-align:left">
				<h2 class="heading mb-35"><?php $this->language->line("SEND-0395",'YOUR ADDRESS (FROM)');?></h2>
                ...
                <p style="font-family:'caption-light'; font-size:100%; color: #ffffff;  text-align: center">
					<?php $this->language->line("SEND-0390",'Your e-mail');?>
                </p>
                <div class="form-group has-feedback">
                    <input 
						...
						class="form-control" 
						style="font-family:'caption-light'; border-radius: 50px;" placeholder="<?php $this->language->line("SEND-040",'Your e-mail');?>" />
                </div>
                <div>
                    <p style="font-family:'caption-light'; font-size:100%; color:#ffffff;  text-align: center">
                        <?php $this->language->line("SEND-130",'Validate Your e-mail address');?>
                    </p>
                </div>
                <div class="form-group has-feedback">
                    <input 
						...
						placeholder="<?php $this->language->line("SEND-140",'Repeat email for verification');?>"
						/>
                </div>
                <div class="form-group has-feedback">
                    <input type="tel" id="sender_mobile"  disabled  class="form-control" style="display: none; font-family:'caption-light'; border-radius: 50px;" placeholder="<?php $this->language->line("SEND-160",'Your mobile number');?>" />
                </div>
				<div class="form-group has-feedback">
					<input id="sender_username" disabled type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-070",'Your full name');?>" />
				</div>
				<div class="form-group has-feedback">
					<input id="sender_address" disabled type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-080",'Your address');?>" />
				</div>
				<div class="form-group has-feedback">
					<input id="sender_addressa" disabled type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-090",'Extra address line');?>" />
				</div>
				<div class="form-group has-feedback">
					<input type="text" id="sender_zipcode" disabled class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-100",'Your zipcode');?>" />
				</div>
				<div class="form-group has-feedback">
					<input type="text" id="sender_city" disabled class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-110",'City');?>" />
				</div>
				<div class="form-group has-feedback">
                ...
                <div style="text-align:center" class="mb-35">
					...
					<label for="labelImage" onclick="triger('labelImage')" class="button button-orange"><?php $this->language->line("SEND-AB1100001",'MAKE AN ITEM PICTURE')?></label>
					<input type="file" name="image" id="labelImage" style="display:none" />
                </div>
                <div class="form-group has-feedback" style="padding: 10px;">
                    <p style="font-family:'caption-light'; font-size:100%; color:#ffffff; text-align: center">
                        <?php $this->language->line("SEND-A1100001",'ITEM CATEGORY')?>
                    </p>
                ...
                <div class="form-group has-feedback" style="padding: 10px;">
                    <p style="font-family:'caption-light'; font-size:100%; color:#ffffff; text-align: center">
						<?php $this->language->line("SEND-A1100002",'ITEM DESCRIPTION')?>
                    </p>
                    <input
                ...
                <div>
                    <p style="font-family:'caption-light'; font-size:100%; color:#ffffff; text-align: center">
						<?php $this->language->line("SEND-A1100003",'ITEM WIDTH (IN CM)')?>
                    </p>
                </div>
                <div class="form-group has-feedback" style="padding: 10px;">
                    <input 
                ...
                <div>
                    <p style="font-family:'caption-light'; font-size:100%; color:#ffffff; text-align: center">
						<?php $this->language->line("SEND-A1100004",'ITEM LENGTH (IN CM)')?>
                    </p>
                </div>
                <div class="form-group has-feedback" style="padding: 10px;">
                    <input
                ...
                <div>
                    <p style="font-family:'caption-light'; font-size:100%; color:#ffffff; text-align: center">
						<?php $this->language->line("SEND-A1100005",'ITEM HEIGHT (IN CM)')?>
                    </p>
                </div>
                <div class="form-group has-feedback" style="padding: 10px;">
                    <input 
                ...
                <div>
                    <p style="font-family:'caption-light'; font-size:100%; color:#ffffff; text-align: center">
						<?php $this->language->line("SEND-A1100006",'ITEM WEIGHT (IN KG)')?>
                    </p>
                </div>
                <div class="form-group has-feedback" style="padding: 10px;">
                    <input 
    ...
    <div class="col-half background-yellow-DHL">
		<div class=" background-orange height-40">
			<div class="width-650">
				<h2 class="heading mb-35"><?php $this->language->line("SEND-4395",'DELIVERY ADDRESS (TO)');?></h2>
                ...
                <p style="font-family:'caption-light'; font-size:100%; color:#ffffff;  text-align: center">
					<?php $this->language->line("SEND-4397",'Recipient email address');?>
                </p>
                <div class="form-group has-feedback">
                    <input 
						type="email"
						...
						required
						class="form-control" style="font-family:'caption-light'; border-radius: 50px; " placeholder="<?php $this->language->line("SEND-A11000010","RECIPIENT EMAIL ADDRESS")?>" />
                </div>
                <div>
                    <p style="font-family:'caption-light'; font-size:100%; color:#ffffff;  text-align: center">
                        <?php $this->language->line("SEND-130",'Validate Your e-mail address');?>
                ...
                <div class="form-group has-feedback" style="padding: 10px;">
                    <input
						...
						class = "form-control"
						style="font-family:'caption-light'; border-radius: 50px; "
						placeholder="<?php $this->language->line("SEND-A1100011","VERIFY RECIPIENT EMAIL ADDRESS")?>"
						/>
                </div>
                <!-- <div>
                    <p style="font-family:'caption-light'; font-size:100%; color:#ffffff; text-align: center">
                ...
                <div class="form-group has-feedback">
                    <input type="tel" id="recipient_mobile"  disabled  class="form-control" style="display: none; font-family:'caption-light'; border-radius: 50px;" placeholder="<?php $this->language->line("SEND-A1100012","RECIPIENT MOBILE NUMBER")?>"  />
                </div>
                <div class="form-group has-feedback">
                    <input id="recipient_username" disabled type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-A1100013","RECIPIENT FULL NAME")?>"  />
                </div>
                <div class="form-group has-feedback">
                    <input id="recipient_address" disabled type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-A1100014","RECIPIENT ADDRESS")?>"  />
                </div>
                <div class="form-group has-feedback">
                    <input id="recipient_addressa" disabled type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-A1100015",'EXTRA ADDRESS LINE');?>" />
                </div>
                <div class="form-group has-feedback">
                    <input type="text" id="recipient_zipcode" disabled class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-A1100016","RECIPIENT  ZIPCODE")?>""  />
                </div>
                <div class="form-group has-feedback">
                    <input type="text" id="recipient_city" disabled class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("SEND-A11000017","RECIPIENT CITY")?>""  />
                </div>
                <div class="form-group has-feedback">
                ...
                <div class="form-group has-feedback">
                    <input  type="button" onclick="checkEmailsAndSubmit('sender_email', 'sender_emailverify', 'recipient_email', 'recipient_emailverify')" class="button button-orange" value="<?php $this->language->line("SEND-A11000020","SEND THE ITEM")?>"  style="border: none" />
                </div>
			</div>
		</div>
...
<!--			<span class='timeline-number text-orange hide-mobile'>1</span>-->
			<div class="timeline-text">
				<div class="timeline-heading">
					...
					<h2 style="font-weight:bold; font-family: caption-bold"><?php $this->language->line("SEND-A1100030","SEND YOUR PACKAGE WITH TIQS")?> </h2>
				</div>
				<p class="text-content-light" style="font-size: larger"><?php $this->language->line("SEND-A1100035","LOST AND FOUND HAS A UNIQUE PACKAGE SENDING PROCESS INTEGRATED WITH DHL AND YOU CAN TAKE ADVANTAGE OF THAT!. SIMPLE SECURE AND FAST. LEARN HOW IN THE VIDEO BELOW.")?></p>
				<div class="flex-column align-space">
					...
					<div align="center" class="mt-50">
						...
						<a class="button button-orange mb-25" id="show-timeline-video-3"><?php $this->language->line("SEND-A1100040","LEARN MORE VIDEO")?></a>
					</div>
				</div>
			</div>
		</div>
