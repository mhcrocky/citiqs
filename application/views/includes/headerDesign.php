    ...
    <header class="header">
        <nav class="header-nav">
            ...
            <div class="header-menu text-orange" id="header-menu">
				<a href="http://localhost/tiqsbox/index.php/Admin" target="_blank"><img width="30px" height="30px" src="<?php echo $this->baseUrl; ?>assets/home/images/print.png" title="LOCAL PRINTERS"/></a>
