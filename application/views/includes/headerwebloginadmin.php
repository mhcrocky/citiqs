...
<html><head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/jquery.magnific-popup.min.js" integrity="sha256-P93G0oq6PBPWTP1IR8Mz/0jHHUpaWL0aBJTKauisG7Q=" crossorigin="anonymous"></script>	<script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    <script src="//cdn.jsdelivr.net/npm/alertifyjs@1.13.1/build/alertify.min.js"></script>
    <script src="<?php echo $this->base_url(); ?>assets/home/js/alertify.js"></script>
    ...
    <nav class="header-nav">
        ...
        <div class="header-menu text-orange" id="header-menu">
			...
			?>
				...
				<a href="<?php echo base_url(); ?>employee">ACCESS</a>
				<a href="<?php echo base_url(); ?>appointmentSetup">TIMETABLE</a>
				<a href="<?php echo base_url(); ?>lostandfoundgridsettings">SETTINGS</a>
				<a href="<?php echo base_url(); ?>PdfDesigner">DESIGNER</a>
				<?php
			}
            ?>
...
<!--            <a href="--><?php //echo base_url(); ?><!--home#dhl-section" id='dhl-button'>DHL</a>-->
