	...
	<div class="col-half background-yellow height-100">
		<div class="flex-column align-start">
			<div class="timeline-heading">
				<h2 style="font-weight:bold; font-family: caption-bold">OEPS, WE DID NOT GET IT....</h2>
			</div>
	...
	<div class="col-half background-blue timeline-content">
		...
		<div class="timeline-block background-orange-light">
			<div class="timeline-text">
				...
				<p class="text-content-light" style="font-size: larger">NOTHING CRITICAL IS BROKEN, SO JUST TRY AGAIN, WE CAN NOT WAIT TO GET OUR COFFEE, OR FRESH CROISSANT, OR DRINK WITH A BURGER, OR PUT OUR TEETH IN A DELICIOUS PIZZA SLICE! FOR DINNER </p>
				<div class="flex-column align-space">
					<div align="center">
						<a href="https://tiqs.com/spot/pay424" target="_self" class="button button-orange">AGAIN</a>
					</div>
				</div>
			</div>
		</div><!-- end timeline block -->
