...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/home/styles/festival-page.css">
...
<div class="main-wrapper" style="margin: 0px">
	...
	<div class="col-half background-purple faq-page height-100">
		<div class="manual-content width-650">
			<h2 class="heading mb-35">MANUALS</h2>
			<button class="accordion">HOW TO SETUP AND TRAIN YOUR STAFF FOR LOST AND FOUND DURING AN EVENT</button>
			...
			<div class="panel">
				...
				<div class="flex-column align-space mb-35">
					<div align="center">
						<a href="<?php echo base_url(); ?>menuapp" target="_blank" class="button button-orange mb-25"><?php $this->language->line("HOWITORKSBUSINESS-2000",'SHOW VIDEO');?></a>
					</div>
				</div>
			</div>
			...
			<div class="panel">
				...
				<div class="flex-column align-space mb-35">
					<div align="center">
						<a href="<?php echo base_url(); ?>menuapp" target="_blank" class="button button-orange mb-25"><?php $this->language->line("HOWITORKSBUSINESS-2100",'SHOW VIDEO');?></a>
					</div>
				</div>
			</div>
			...
			<div class="panel">
				...
				<div class="flex-column align-space mb-35">
					<div align="center">
						<a href="<?php echo base_url(); ?>menuapp" target="_blank" class="button button-orange mb-25"><?php $this->language->line("HOWITORKSBUSINESS-2200",'SHOW VIDEO');?></a>
					</div>
				</div>
			</div>
