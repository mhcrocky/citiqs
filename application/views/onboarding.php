...
<div class="card">
	<div class="products">
		<div class="product active background-orange" product-id="1" value="peter">
			<div style="text-align:center">
				...
				<ul style="list-style-type: none  ;font-family: caption-light; font-size:larger;  margin-left: -40px " align="center">
					<li><?=$this->language->line("CHECK424-0200011ABCD",'MAKE A QRCode VALID FOR 24 HOURS, SO THAT YOU CAN QUICKLY, PRIVATELY ENTER A VENUE.');?></li>

				</ul>
				<ul style="list-style-type: none  ;font-family: caption-light; font-size:larger;  margin-left: -40px " align="center">
					<li><?=$this->language->line("CHECK424-0200012ABCD",'');?></li>
					<li><?=$this->language->line("CHECK424-0200032ABCD",'PLEASE UNDERSTAND THAT YOUR ANSWERS NEED TO BE HONEST TO KEEP YOU AND YOUR LOVED ONES SAVE.');?></li>
					<li><?=$this->language->line("CHECK424-0200012ABCD",'');?></li>
				...
				<ul style="list-style-type: none  ;font-family: caption-light; font-size:smaller;  margin-left: -40px " align="center">
					...
					<li><?=$this->language->line("CHECK424-10200032ABCD",'(Available in more than 100 languages.)');?></li>
					<li><?=$this->language->line("CHECK424-10200012ABCD",'');?></li>
				</ul>
			...
			<div>
				...
				<div>
					<p style="font-size: larger; font-family: caption-light">
						<?=$this->language->line("CHECK424-Q0001ABCD",'Check this box, when you do NOT sneeze and/or cough and/or are short of breath and/or have a fever and/or temperature higher than 38 degrees');?>
					</p>
				</div>
				...
				<div>
					<p style="font-size: larger; font-family: caption-light">
						<?=$this->language->line("CHECK424-Q0005ABC",'Check this box, when you where NOT tested for COVID-19 in the last 7 days and or DID NOT had COVID-19 in the last 7 days');?>
					</p>
				</div>
				<div class="form-group has-feedback" align="center">
					<div class="onoffswitchblue">
				...
				<div>
					<p style="font-size: larger; font-family: caption-light">
						<?=$this->language->line("CHECK424-Q00015A",'Check this box, when you where NOT in contact with someone who was tested within 14 days for COVID-19 and showed symptoms.');?>
					</p>
				</div>
				<div class="form-group has-feedback" align="center">
					<div class="onoffswitchblue">
		...
		<div class="product background-orange setpn" product-id="3" >
			...
			<div>
				<p style="font-size: larger; font-family: caption-light">
					<?=$this->language->line("CHECK424-02000112AB",'ADDITIONALY WE HAVE TO ASK ABOUT THE HEALTH OF CLOSE RELATIVES ');?>
					<br/>

				</p>
				<div>
					<p style="font-size: larger; font-family: caption-light">
						<?=$this->language->line("CHECK424-Q00011A",'Check this box, when roommates, household members are NOT sneezing and/or coughing and/or short of breath and/or having a fever and/or temperature higher dan 38 degrees');?>
					</p>
				</div>
				<div class="form-group has-feedback" align="center">
					<div class="onoffswitchblue">
				...
				<div>
					<p style="font-size: larger; font-family: caption-light">
						<?=$this->language->line("CHECK424-Q00016AB",'Check this box, when roommates, household members where NOT in contact with someone who was tested within 14 days for COVID-19 and showed symptoms.');?>
					</p>
				</div>
				<div class="form-group has-feedback" align="center">
					<div class="onoffswitchblue">
			...
			<div>
				<p style="font-size: larger; font-family: caption-light">
					<?=$this->language->line("CHECK424-Q00017ABCD",'Check this box, when you are NOT in quarantine or any of your roommates, household members.');?>
				</p>
			</div>
			<div class="form-group has-feedback" align="center">
				<div class="onoffswitchblue">
		...
		<div class="product background-orange setp" product-id="4" >
			...
			<div class="form-group has-feedback mb-50" >
				<div style="text-align: center; ">
					<input  type="submit" class="button button-orange" value="<?=$this->language->line("CHECK424-1240A",'GET YOUR QRCODE');?>" style="border: none" />
				</div>
			</div>

			<div>
				<p style="font-size: larger; font-family: caption-light">
					<?=$this->language->line("CHECK424-Q000189BCD",'AFTER 24 HOURS THE QRCode WILL BE INVALID AND YOU CAN MAKE A NEW ONE.');?>
				</p>
			</div>
...
<div class="col-half background-yellow">
	<div class="background-orange-light height">
		...
		<div class="text-center mb-50" style="text-align:center">
			...
			<div class="form-group has-feedback mt-50" >
				<div style="text-align: center; ">
					<input  type="submit" class="button button-orange" value="<?=$this->language->line("CHECK424-100240AB",'BUY US A COFFEE');?>" style="border: none" />
				</div>
			</div>
			<div class="text-center mb-50" style="text-align:center">
	...
	<div class="background-yellow height-50">
		...
		<div class="form-group has-feedback mt-50" >
			<div style="text-align: center; ">
				<input  type="submit" class="button button-orange" value="<?=$this->language->line("CHECK424-100240BA",'BUY US A COFFEE');?>" style="border: none" />
			</div>
		</div>
	</div>
	</div>
