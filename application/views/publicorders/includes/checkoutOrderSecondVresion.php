<div class="row d-flex justify-content-center">
    <div class='col-sm-12 col-lg-9'>
        <div class="checkout-table">
		   ...
		   <!-- CHECKOUT MESSAGE -->
		   <div class='checkout-message' style='margin-top: 100px;
		   margin-bottom: 100px;'>
				...
				<div class="checkout-message__content">
					...
					<div class='checkout-message__details'>
						<h3>spot: table<span class='checkout-message__spot'></span> 88</h3>
						<h3>order n<sup>o</sup>: <span class='checkout-message__order'>99</span></h3>
						<h3>amount: <span class='checkout-message__amount'>99</span></h3>
					</div>
					<h3 class='order-status order-status--true'>please be patiente we are now working on that</h3>
				</div>
				<div class="checkout-btns">
				<a href="http://localhost:8080/alfred/alfred/make_order?vendorid=417&amp;spotid=717" style="background-color: #948b6f" class="button">
