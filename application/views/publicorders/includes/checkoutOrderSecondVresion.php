                                        ...
                                        <div class='checkout-table__numbers'>
                                            <div class="checkout-table__quantity">
                                                ...
                                                <input
                                                    ...
                                                    data-initial-min="<?php echo $addon['minQuantity']; ?>"
                                                    data-initial-max="<?php echo $addon['maxQuantity']; ?>"
                                                    data-initial-value="<?php echo $addon['quantity']; ?>"
                                                    type="number"
                                                    step="<?php echo $addon['step']; ?>"
                                                    min="<?php echo (floatval($addon['minQuantity']) / floatval($addon['step'])); ?>"
                                                    max="<?php echo (floatval($addon['maxQuantity']) / floatval($addon['step'])); ?>"
