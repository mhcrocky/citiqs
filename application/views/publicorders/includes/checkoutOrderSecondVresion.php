                                        ...
                                        <div class='checkout-table__numbers'>
                                            <div class="checkout-table__quantity">
                                                ...
                                                <input
                                                    ...
                                                    data-initial-min="<?php echo (floatval($product['quantity']) / floatval($addon['minQuantity'])); ?>"
                                                    data-initial-max="<?php echo (floatval($addon['maxQuantity']) / floatval($product['quantity'])); ?>"
                                                    data-initial-value="<?php echo (floatval($addon['quantity']) / floatval($addon['step'])); ?>"
                                                    type="number"
