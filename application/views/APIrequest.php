		...
		<div class="flex-column align-start">
			<div align="left">
				<h2 class="heading mb-35">
					<?=$this->language->line('API-A10001','REQUEST API ACCESS');?>
				</h2>
			...
			<div class="timeline-text">
				<div class="timeline-heading">
					...
					<h2 style="font-weight:bold; font-family: caption-bold">
						<?=$this->language->line('API-A100011','
					     FILL THE FORM 
					');?></h2>
				</div>
				<p class="text-content-light" style="font-size: larger">
					<?=$this->language->line('API-A100012','
		...
		<div class="timeline-block background-orange-light">
			...
			<div class="timeline-text">
				<div class="timeline-heading">
					...
					<h2 style="font-weight:bold; font-family: caption-bold">
						<?=$this->language->line('API-A100013','
					     API MANUAL AND API ACCESS  
					');?></h2>
				</div>
				<p class="text-content-light" style="font-size: larger">
					<?=$this->language->line('API-A100014a','
		...
		<div class="timeline-block background-green-environment">
			...
			<div class="timeline-text">
				<div class="timeline-heading">
					...
					<h2 style="font-weight:bold; font-family: caption-bold">
						<?=$this->language->line('API-A100015','
					     SUPPORT ON API DEVELOPMENT
					');?></h2>
				</div>
				<p class="text-content-light" style="font-size: larger">
					<?=$this->language->line('API-A100016','
		...
		<div class="timeline-block background-apricot timeblock-last">
			...
			<div class="timeline-text">
				<div class="timeline-heading">
					...
					<h2 style="font-weight:bold; font-family: caption-bold">
						<?=$this->language->line('API-A100017','
					     CONTRACT AND SUPPORT  
					');?></h2>
				</div>
				<p class="text-content-light" style="font-size: larger">
					<?=$this->language->line('API-A100018a','
