	...
	<div class="col-half background-green height-100">
		<div class="flex-column align-start">
			<div class="timeline-heading">
				<h2 style="font-weight:bold; font-family: caption-bold"><?=$this->language->line('PAYMENTSUCCESS-CHECK424001','THANK YOU FOR YOUR KIND DONATION');?></h2>
			</div>
	...
	<div class="col-half background-blue timeline-content">
		<div class="timeline-block background-orange">
			<div class="timeline-text">
				...
				<p class="text-content-light" style="font-size: larger">WE ARE ENJOYING YOUR DONATION ...</p>
			</div>
		</div>
