...
<div class="main-wrapper">
	<div class="col-half background-orange height-100">
		<div class="flex-column align-start">
			<div class="timeline-heading">
				<h2 style="font-weight:bold; font-family: caption-bold">VOOR DE EERSTE EDITIE ZIJN UITVERKOCHT, DE VOLGENDE EDITIES KOMEN ER AAN!</h2>
			</div>
	...
	<div class="col-half background-yellow-orange timeline-content">
		<div class="timeline-block background-yellow-orange">
			<div class="timeline-text">
				<div class="timeline-heading">
					<h2 style="font-weight:bold; font-family: caption-bold">WE HEBBEN GEEN ENKELE BOOKING MOGELIJKHEID MEER </h2>
				</div>
				<p class="text-content-light" style="font-size: larger">HET SPIJT ONS.</p>
			</div>
		...
		<div class="timeline-block background-orange-light">
			<div class="timeline-text">
				<div class='timeline-heading'>
					<h2 style="color:white; font-weight:bold; font-family: caption-bold">TRY AGAIN....</h2>
				</div>
