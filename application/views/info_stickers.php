        ...
        <div class="col-half col-testimonial">
            <div class='col-testimonial-content'>
                ...
                <div class="testimonial-row">
					...
					<div class="mb-35">
						<a href="<?php echo base_url(); ?>ordertags" class="button button-orange"><?php $this->language->line('TAGS-A0010','ORDER YOUR PERSONAL TIQS-TAGS');?></a>
					</div>
		...
		<div class="flex-column align-start width-650">
			<div align="left">
				...
				<div class="mb-35" align="left">
					<a href="<?php echo base_url(); ?>legal" class="button button-orange"><?php $this->language->line('INFODHL-A0101','GDPR AND LEGAL STATEMENTS');?></a>
				</div>
