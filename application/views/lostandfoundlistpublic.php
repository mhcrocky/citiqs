...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        ?>
      <h1>
        <i class="fa fa-tags"></i>  <large><?php echo $location ?></large> <small><?=$this->language->line("xxx-xxx",'Found items');?>
          </small>
      </h1>
    </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?=$this->language->line("xxx-xxx",'list of items');?></h3>
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>lostandfoundlistpublic" method="POST" id="searchList">
                            <div class="input-group">
                              <input type="text" name="searchText" value="<?php echo $searchText; ?>" class="form-control input-sm pull-right" style="width: 150px;" placeholder=<?=$this->language->line("xxx-xxx","Search");?> >
...
<!--                        <th class="text-left">Claimed</th>-->
                        <th><?=$this->language->line("xxx-xxx",'Code');?></th>
                        <th><?=$this->language->line("xxx-xxx",'Image');?></th>
                        <th><?=$this->language->line("xxx-xxx",'Description');?></th>
                        <th><?=$this->language->line("xxx-xxx",'Category');?></th>
                        <th><?=$this->language->line("xxx-xxx",'Date found');?></th>
...
<!--                                <button type="submit" name="labelimage" value="Submit" >Submit</button>-->
                                <?php if (!empty($record->image)) { ?>
                                <a data-fancybox="gallery" href="<?php echo base_url(); ?>uploads/LabelImages/<?=$record->userId?>-<?=$record->code;?>-<?=$record->image;?>" _target="blank"><img height="32" width="32" src="<?php echo base_url(); ?>tiqsimg/zoomIn.png" title=<?=$this->language->line("xxx-xxx","Zoom");?>></a>
                                <?php } ?>
                            </form>
                        </td>
