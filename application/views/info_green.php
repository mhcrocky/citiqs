<!DOCTYPE html>
<html><head>
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/home/styles/green-page.css">
</head>
<body>
<section class="section-2 background-green-environment" id='dhl-section'>
        <div class="col-half col-testimonial">
            <div class='col-testimonial-content text-green'>
						   ...
						   <div id="testimonials-wrapper" class="text">
							<div class="testimonial testimonial-one">
								<div class="testimonial-section__text-wrapper">
									<p class="testimonial-section__text">THE WORLDWIDE LOST AND FOUND STANDARD.<br><br>PARTNER DHL EXPRESS<br><br>GREEN SUPPORTED. <br><br> LOST BY YOU, RETURNED BY US.
									</p>
								</div>
							</div>
