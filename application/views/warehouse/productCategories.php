		...
		<div class="grid-list">
            ...
            <?php } else { ?>
				...
				<?php foreach ($categories as $category) { ?>
					<div class="grid-item list-categories listCategories" data-category-id="<?php echo $category['categoryId']; ?>" style="background-color:<?php echo $category['active'] === '1' ? '#72b19f' : '#ff4d4d'; ?>">
