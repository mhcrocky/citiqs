<div class="main-wrapper">
	...
	<div class="col-half background-blue height-100">
		<div class="flex-column align-start">
			<div style="text-align:left">
				<h2 class="heading mb-35">
					<?php $this->language->line('Home-HH10001','BUSINESS LOST AND FOUND');?>
				</h2>
				<p style="font-family: caption-light" class="text-content mb-35"><?php $this->language->line("HOME-AZ003",'LOST BY YOUR VISITOR,<br> RETURNED BY US.');?></p>
				<a href="<?php echo base_url(); ?>home" class="button button-orange mb-35"><?php $this->language->line("HOMENEW-004",'GOTO BUSINESS');?></a>
	...
	<div class="col-half background-orange height-100 div-no-mobile">
		...
		<div class=" background-orange">
			<div class="width-650">
				<h2 class="heading mb-35">
					<?php $this->language->line('HOMENEW-0002','PERSONAL LOST AND FOUND');?>
				</h2>
				<h2 class="heading mb-35">
					<p style="font-family: caption-light" class="text-content mb-35"><?php $this->language->line("Home-11a11003",'LOST BY YOU,<br> RETURNED BY US.');?></p>
				</h2>
				<div class="mb-35">
					<a href="<?php echo base_url(); ?>home" class="button button-orange mb-35"><?php $this->language->line("HOMENEW-01610",'GOTO PERSONAL');?></a>
				</div>
			</div>
...
<div class="footer-container">
	<div class="footer-box background-yankee">
		<h2 class="heading mb-35">
			<?php $this->language->line('Home-INVESTOR0001B','BUSINESS PARTNER AND INVESTOR RELATIONSHIPS');?>
		</h2>
		<div style="text-align:left; margin-top: 150px; margin-bottom: -50px; margin-left: 0px ">
			<a style="color: #0b0b0b" href="<?php echo base_url(); ?>send" class="button button-orange "><?php $this->language->line("HOME-INVESTOR005",'MORE INFO');?> </a>
		</div>
		...
		<div style="margin-top: 240px;" >
			<h2 class="heading mb-35"> <?php $this->language->line("Home-NEWS00022",'BUSINESS PARTNERSHIP OPPORTUNITIES');?></h2>
			<div class="mb-35">
				<h3 class="text-white mb-35" style="font-family: 'caption-light', caption-light">
					<a href="https://tiqs.com/lostandfound/send"><?php $this->language->line("HOME-NEWS003",'LATEST BUSINESS AND INVESTOR NEWS');?></a>
				</h3>
			</div>
		</div>
	</div>
	<div class="footer-box background-orange">
		<h2 class="heading mb-35">
			<?php $this->language->line('Home-NEWS0001B','LATEST NEWS TIQS LOST AND FOUND');?>
		</h2>
		<div style="text-align:left; margin-top: 100px; margin-bottom: -50px; margin-left: 0px ">
			<a style="color: #0b0b0b" href="<?php echo base_url(); ?>send" class="button button-orange "><?php $this->language->line("HOME-KIDS005ABCD",'MORE INFO');?> </a>
		</div>
		...
		<div style="margin-top: 240px;" >
			<h2 class="heading mb-35"> <?php $this->language->line("Home-NEWS0002",'NEW KIDS PROGRAM FOR TOY SHOPS');?></h2>
			<div class="mb-35">
				<h3 class="text-white mb-35" style="font-family: 'caption-light', caption-light">
					<a href="https://tiqs.com/lostandfound/send"><?php $this->language->line("HOME-NEWS003",'LATEST NEWS ABOUT TIQS LOST AND FOUND');?></a>
				</h3>
			</div>
		</div>
	</div>
	<div class="footer-box background-yellow-DHL">
		...
		<div class="mb-35">
			...
			<a style="color: #0b0b0b" href="<?php echo base_url(); ?>send" class="button button-orange mb-35"><?php $this->language->line("HOME-HAC101111",'SEND YOUR ITEM');?></a>
		</div>
	</div>
