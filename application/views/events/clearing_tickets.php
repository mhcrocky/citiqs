                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-md-6 p-left">
                                ...
                                <div style="flex-wrap: unset;" class="d-flex justify-content-between pt-10px b-bottom">
                                    ...
                                    <div class="font-weight-bold">
                                    € <span id="promoterPaid"><?php echo isset($event_stats['promoterPaid']) ? number_format($event_stats['promoterPaid'], 2) : '0.00'; ?></span>
                                    </div>
...
setTimeout(() => {
    $('.dataTables_paginate').addClass('d-flex').addClass('justify-content-end');
    $('#eventClearings_filter').closest('.col-sm-12').addClass('d-flex').addClass('justify-content-end');
}, 300);
