        ...
        <div  id="choosePaymentMethod" class="bar" style="width:100 vw; height:100">
            ...
            <div id="paymentContainer" class="payment-container methods">
					<?php if (in_array($payconiqPaymentText, $activePayments)) { ?>
						<a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $payconiqPaymentType; ?>/0<?php echo '?order=' . $orderRandomKey; ?>" class="paymentMethod method-card addTargetBlank">
                    ...
                    <?php if (in_array($creditCardPaymentText, $activePayments)) { ?>
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $creditCardPaymentType; ?>/0<?php echo '?order=' . $orderRandomKey; ?>" class="paymentMethod method-card addTargetBlank">
                    ...
                    <?php if (in_array($bancontactPaymentText, $activePayments)) { ?>
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $bancontactPaymentType; ?>/0<?php echo '?order=' . $orderRandomKey; ?>" class="paymentMethod method-card addTargetBlank">
                    ...
                    <?php if (in_array($myBankPaymentText, $activePayments)) { ?>
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $myBankPaymentType; ?>/0<?php echo '?order=' . $orderRandomKey; ?>" class="paymentMethod method-card addTargetBlank">
            ...
            <?php if (in_array($idealPaymentText, $activePayments)) { ?>
                <div class="method method-ideal text-center hidden"  id="idealBanks">
                    ...
                    <div class="payment-container">
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/1<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod abn_amro addTargetBlank">
                            <img src="https://tiqs.com/alfred/assets/home/imgs/extra/abn_amro.png" alt="ABN AMRO">
                            <span class="paymentMethodText">ABN AMRO</span>
                        </a>
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/8<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod asn_bank addTargetBlank">
                            <img src="https://tiqs.com/alfred/assets/home/imgs/extra/asn_bank.png" alt="ASN Bank">
                            <span class="paymentMethodText">ASN Bank</span>
                        </a>
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/5080<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod bunq addTargetBlank">
                            <img src="https://tiqs.com/alfred/assets/home/imgs/extra/bunq.png" alt="Bunq">
                            <span class="paymentMethodText">Bunq</span>
                        </a>
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/5082<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod handelsbanken addTargetBlank">
                        ...
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/4<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod ing addTargetBlank">
                            <img src="https://tiqs.com/alfred/assets/home/imgs/extra/ing.png" alt="ING">
                            <span class="paymentMethodText">ING</span>
                        </a>
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/12<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod knab addTargetBlank">
                            <img src="https://tiqs.com/alfred/assets/home/imgs/extra/knab(1).png" alt="Knab">
                            <span class="paymentMethodText">Knab</span>
                        </a>
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/5081<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod moneyou addTargetBlank">
                            <img src="https://tiqs.com/alfred/assets/home/imgs/extra/moneyou.png" alt="Moneyou">
                            <span class="paymentMethodText">Moneyou</span>
                        </a>
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/2<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod rabobank addTargetBlank">
                            <img src="https://tiqs.com/alfred/assets/home/imgs/extra/rabobank.png" alt="Rabobank">
                            <span class="paymentMethodText">Rabobank</span>
                        </a>
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/9<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod regiobank addTargetBlank">
                        ...
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/5<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod sns_bank addTargetBlank">
                            <img src="https://tiqs.com/alfred/assets/home/imgs/extra/sns_bank.png" alt="SNS Bank">
                            <span class="paymentMethodText">SNS Bank</span>
                        </a>
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/10<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod triodos_bank addTargetBlank">
                        ...
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $idealPaymentType; ?>/11<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod van_lanschot addTargetBlank">
                ...
                <div class="method method-ideal hidden"  id="giroBanks">
                    ...
                    <div class="payment-container">
                        <a href="<?php echo base_url(); ?>booking/onlinepayment/<?php echo $giroPaymentType; ?>/0<?php echo '?order=' . $orderRandomKey; ?>" class="bank paymentMethod addTargetBlank">
