                            ...
                            <div class="carousel-inner">
								...
								<div class="item active">
									<div style="text-align:center">
										<h2 class="heading mb-35">
											<?php $this->language->line("CHECK-010",'WELCOME TO THE WORLD LARGEST SIMPLE, HONEST LOST AND FOUND SOLUTION.');?>
										</h2>
									</div>
								...
								<div class="item">
                                    <div class="login-box">
                                        <p id="UnkownAddressText" style="font-family:'caption-light'; display:none; font-size:100%; color:#ffffff;  text-align: center">
                                            <?php $this->language->line("CHECK-050",'HI!, WELCOME, AS A NEW MEMBER TO THE WORLD LARGEST HONEST LOST AND FOUND COMMUNITY!')?>
                                            <?php $this->language->line("CHECK-060",'
                                    ...
                                    <div class="form-group has-feedback">
                                        <input id="username" name="user[username]" type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CHECK-070",'Your full name');?>" />
                                    </div>
                                    <div class="form-group has-feedback">
                                        <input id="address" name="user[address]" type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CHECK-080",'Your address');?>" />
                                    </div>
                                    <div class="form-group has-feedback">
                                        <input id="addressa" name="user[addressa]" type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CHECK-090",'Extra address line');?>" />
                                    </div>
                                    <div class="form-group has-feedback">
                                        <input type="text" id="zipcode" name="user[zipcode]" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CHECK-100",'Your zipcode');?>" />
                                    </div>
                                    <div class="form-group has-feedback">
                                        <input type="text" id="city" name="user[city]" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CHECK-110",'City');?>" />
                                    </div>
                                    ...
                                    <div>
                                        <p style="font-family:'caption-light'; font-size:100%; color:#ffffff; text-align: center">
                                            <?php $this->language->line("CHECK-150",'Your mobile phone number for SMS when someone finds this registered item. Number formatted as country code and phone number 0099123456789');?>
                                        </p>
                                    </div>
                                    <div class="form-group has-feedback">
                                        <input type="tel" name="user[mobile]" class="form-control" style="font-family:'caption-light'; border-radius: 50px;" placeholder="<?php $this->language->line("CHECK-160",'Your mobile number');?>" />
                                    </div>
                                    <div class="form-group has-feedback align-center">
                                        <div>
                                            <p style="font-family:'caption-light'; font-size:100%; color: #fff9df">
                                                <?php $this->language->line("CHECK-1170",'Check this box, when your code is attached to your mobile phone. (SMS will be send to your friends phone)');?>
                                            </p>
                                        </div>
                                        <div class="form-group has-feedback align-center">
                                    ...
                                    <div>
                                        <p style="font-family:'caption-light'; font-size:100%; color:#ffffff; text-align: center">
                                            <?php $this->language->line("CHECK-180",'Your friends mobile number, when you lost your phone. Number formatted as country code and phone number 0099123456789');?>
                                        </p>
                                    </div>
                                    <div class="form-group has-feedback">
                                        <input type="tel" name="user[lfbmobile]" class="form-control" style="font-family:'caption-light'; border-radius: 50px;" placeholder="<?php $this->language->line("CHECK-190",'Your friends mobile number');?>" />
                                    </div>
                                </div>
                                <?php } ?>
                                ...
                                <div class="item">
                                    ...
                                    <div class="form-group has-feedback" style="padding: 10px">
                                        ...
                                        <input id="inputManualCode" oninput="hideElement(this, 'imageDiv')" type="text" name="label[code]" class="form-control" placeholder="<?php $this->language->line("CHECK-200",'Unique code from sticker or tag');?>" style="font-family:'caption-light'; border-radius: 50px;" />
                                    </div>
                                    <div>
                                        <p style="font-family:'caption-light'; font-size:100%; color:#ffffff; text-align: center">
                                            <?php $this->language->line("CHECK-123210",'PLEASE ENTER THE UNIQUE CODE FROM THE STICKER/TAG. BY PRESSING THE "REGISTER YOUR ITEM" BUTTON IT IS ADDED TO YOUR ACCOUNT, NO TAGS OR STICKERS?, YOU CAN MAKE A PICTURE');?>
                                        </p>
                                    </div>
                                    <div style="text-align:center" class="mb-35" id="imageDiv">
                                        <label for="labelImage" onclick="triger('labelImage')" class="button button-orange"><?php $this->language->line("CHECK-C211032",'MAKE A PICTURE ');?></label>
                                ...
                                <div class="item">
                                    ...
                                    <div class="form-group has-feedback" style="padding: 10px">
                                        <p style="font-family:'caption-light'; font-size:100%; color:#ffffff; text-align: center">
                                            <?php $this->language->line("CHECK-C122111032",'SELECT AN ITEM CATEGORY');?>
                                        </p>
                                        <div class="selectWrapper" id="caterory" style="background-color: #e25f2a;">
                                            ...
                                            <select class="selectBox" name="label[categoryid]" requried style="font-family:'caption-light'; background-color: #eec5a7; border-radius: 50px; height: 32px;" >
                                                <option value="">
                                                    <?php $this->language->line("CHECK-C22311032",'Select');?>
                                                </option>
                                                <?php
                                    ...
                                    <div class="form-group has-feedback" >
                                        <div style="text-align: center; ">
                                            <?php if (isset($userId)) { ?>
                                            <input  type="submit" class="button button-orange" value="<?php $this->language->line("CHECK-240",'REGISTER YOUR ITEM');?>" style="border: none" />
                                            <?php } else { ?>
                                            <input  type="button" onclick="checkValuesAndSubmit('checkItem', 'email', 'emailverify')" class="button button-orange" value="<?php $this->language->line("CHECK-240",'REGISTER YOUR ITEM');?>" style="border: none" />
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
...
<!--                            </div>-->
    ...
    <div class="col-half background-yellow">
        <div class="background-orange-light height">
            <div class="width-650">
                <h2 class="heading mb-35"><?php $this->language->line("CHECK-250",'<a href="https://tiqs.com/lostandfound/personaltagsinfo">GET YOUR FREE TIQS <br>PERSONAL LOST + FOUND<br>STICKERS</a>');?></h2>
                ...
                <a style="color:#ffffff" class='how-we-works-link' href="<?php echo $this->baseUrl; ?>howitworksconsumer"><?php $this->language->line("CHECK-260",'MORE INFO, HOE IT WORKS');?></a>
                <p class="text-content mb-50"><?php $this->language->line("CHECK-70",'LOST BY YOU, <br> RETURNED BY US');?></p>
                <a href="<?php echo $this->baseUrl; ?>check" class="button button-orange mb-35"><?php $this->language->line("CHECK-280",'ORDER YOUR FREE STICKERS');?></a>
            </div>
        ...
        <div class="background-yellow height-50">
            <div class="width-650">
                <h2 class="heading mb-35"><?php $this->language->line("CHECK-A251",'TELL A FRIEND.');?></h2>
                ...
                <form action="<?php echo $this->baseUrl; ?>loginMe" method="post" class='homepage-form'>
                    <form action="<?php echo $this->baseUrl; ?>checkregister" method="post">
                        <div class="form-group has-feedback">
                            <input type="email" id="brandemail" class="form-control" style="font-family:'caption-light'; border-radius: 50px; " placeholder="<?php $this->language->line("CHECK-252",'Your e-mail');?>" id="brandemail" name="email" onfocusout="myFunctionBrand(this.value)"/>
                        </div>
                        ...
                        <p id="brandUnkownAddressText" style="font-family:'caption-light'; margin-bottom: 10px; display:none; font-size:100%; color:#ffffff;  text-align: left" >
                                <?php $this->language->line("CHECK-290",'THANKS, FOR YOUR APPLICATION AS BRAND AMBASSADOR FOR SUPPORTING TO THE WORLD LARGEST HONEST LOST AND FOUND COMMUNITY!')?>
                                <?php $this->language->line("CHECK-300",'
                                Please state your Name, home (or other physical address). 
                                Your personal data is encrypted stored for security reasons 
                        ...
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CHECK-310",'Your full name');?>" id="brandname" name="name"  />
                        </div>

                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CHECK-320",'Your address');?>" id="brandaddress" name="address"  />
                        </div>

                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CHECK-330",'Extra address line');?>" id="brandaddressa" name="addressa"  />
                        </div>

                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CHECK-340",'Your zipcode');?>" id="brandzipcode" name="zipcode" />
                        </div>

                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="display: none; font-family:'caption-light'; border-radius:50px; " placeholder="<?php $this->language->line("CHECK-350",'City');?>" id="city" name="brandcity"  />
                        ...
                        <div class="form-group has-feedback" >
                            <div style="text-align: center; margin-bottom: 30px ">
                                <input type="submit" class="button button-orange" value="<?php $this->language->line("CHECK-370",'APPLY');?>" style="border: none" />
                            </div>
                        </div>
                    </form>
            </div>
