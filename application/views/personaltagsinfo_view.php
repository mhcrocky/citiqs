                           ...
                           <div id="testimonials-wrapper" class="text">
                                ...
                                <div class="testimonial testimonial-one">
                                    <div class="testimonial-section__text-wrapper">
                                        <p class="testimonial-section__text">YOU ARE HONEST! AND SO IS 99% OF HUMANITY!
                                            <br>WE BELIEVE IN HONESTY! AS WE ARE FAMILIAR WITH THE ANXIETY AND FRUSTRATION WHEN SOMETHING GOES MISSING.
                                            <br>HOW FRUSTRATING IS IT, WHEN YOUR LOST ITEM IS FOUND, IF IT WILL ACTUALLY END UP BACK TO YOU?.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="testimonial testimonial-two">
                                    <div class="testimonial-section__text-wrapper">
                                        <p class="testimonial-section__text"> <h1>WHO IS THE OWNER?</h1>
                                        <br>PEOPLE COULD LEAVE, YOUR FOUND ITEM, AS IS, TRY TO FIND YOU VIA SOCIAL MEDIA, ALTERNATIVELY DROP IT OFF AT A LOCAL BUSINESS, OR TAKE THE EFFORT TO FILE A REPORT AT A LAW ENFORCEMENT OFFICE.
                                        <br><br> ALL BECAUSE THEY DO NOT KNOW THAT YOU ARE THE OWNER!
                                        </p>
                                    </div>
                                </div>
                               ...
                               <div class="testimonial testimonial-three">
                                   <div class="testimonial-section__text-wrapper">
                                       <p class="testimonial-section__text"> <h1>HOW SIMPLE IS THIS!</h1>
                                       <br>YOU JUST TAG YOUR PRECIOUS BELONGINGS, WITH A TIQS-TAG-BAG, KEYCHAIN HANGER OR OUR FREE STICKERS. REGISTER WITH TIQS AND THAT'S ALL!
                                       </p>
                                   </div>
                               </div>
                               ...
                               <div class="testimonial testimonial-four">
                                   <div class="testimonial-section__text-wrapper">
                                       <p class="testimonial-section__text"><h1>LOST BY YOU.</h1>
                                           <h1>RETURNED BY US.</h1>
                                           <br>WHEN SOMEONE FINDS YOUR LOST ITEM, OUR PLATFORM FILLS IN THE DOTS, CONNECTS THE MISSING LINK AND GET'S IT BACK TO YOU.
                                       </p>
                                   </div>
                               </div>
                                ...
                                <div class="testimonial testimonial-five">
                                    <div class="testimonial-section__text-wrapper">
                                        <p class="testimonial-section__text">
                                            LOST & FOUND BY TIQS PROVIDES YOU A SINGULAR ONLINE TOOL RESTORING TRUST IN HUMANITY, IN EVERY ITEM LOST & FOUND AND BACK TO YOU.
                                        </p>
                                    </div>
                                </div>
...
<!--                               </div>-->
                    ...
                    <div>
                        <a href="https://tiqs.com/lostandfound/howitworksconsumer" class="button button-orange"><?=$this->language->line("xxx-xxx",'HOW IT WORKS');?></a>

						<a href="https://tiqs.com/lostandfound/check" class="button button-orange"><?=$this->language->line("xxx-xxx",'ORDER YOUR TAGS');?></a>
					</div>
                    ...
                    <p class="text-content-light" style="font-size: 10px; padding-top: 10px" >
        ...
        <div class="col-half col-slider mobile-hide">
            <div class="slideshow-container">
                ...
                <div class="mySlides fade mySlides-6">
                    <img src="" style="width:100%">
                </div>

                <div class="mySlides fade mySlides-7">
                    <img src="" style="width:100%">
                </div>
...
<script type="text/javascript">
    ...
    setInterval(function(){
        ...
        if(testimonialCounter <= testimonialSize){
            moveRight ();
            testimonialCounter++;
        }else{
