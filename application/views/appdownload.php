...
<html><head>
    ...
    <link rel="stylesheet" href="assets/home/styles/app-page.css">
        ...
        <div class="col-half col-testimonial">
            <div class='col-testimonial-content'>
                <div class="testimonial-row">
                    ...
                    <div class="mb-35">
                        <a href="<?php echo base_url(); ?>howitworksbusiness" class="button button-orange mb-35"><?php echo $this->language->line("HABINFO-010",'HOW IT WORKS');?></a>
					</div>
					...
					<a href="https://play.google.com/store/apps/details?id=hospitality.tiqs.app&hl=en" target="_blank">
						<img src="<?php echo base_url(); ?>assets/home/images/googlestore.png" alt="DOWNLOAD ON GOOGLE STORE" style="width:120px;height:45px;border:0;">
					</a>
...
<!--					<input name="appstore" type="image" src="--><?php //echo base_url(); ?><!--assets/home/images/appstore.png" alt="Download on Apple store" />-->
<!--					<input type="button" href="https://apps.apple.com/us/app/tiqs-hospitality-lost-found/id1481467292"  src="--><?php //echo base_url(); ?><!--" />-->
