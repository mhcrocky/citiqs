		...
		<div class="flex-column align-start">
			<div align="left">
				<p style="font-family:'caption-bold'; font-size:200%; color:#ffffff; text-align: center; ">
					<?=$this->language->line("BAGIT-010",'UNIQUE CODE');?>
				</p>
				<p style="font-family:'caption-bold'; font-size:100%; color:#ffffff; text-align: center; ">
					<?=$this->language->line("BAGIT-A010",'WRITE THIS NUMBER ON THE TIQS-BAG');?>
				</p>
		...
		<div class="timeline-block background-orange-light">
			...
			<div class="timeline-text">
				...
				<div class="flex-column align-space">
					...
					<div align="center">
						<!--                                href="https://tiqs.com/lostandfound/menuapp target="_blank"" -->
							<a href="<?php echo base_url()?>itemfound/<?php echo $token?>/<?php echo $userId?>" class="button button-orange mb-25"><?=$this->language->line("BAGIT-LA1900",'REGISTER AN OTHER FOUND ITEM');?></a>
					</div>
				</div>
			</div>
		</div><!-- end timeline block -->
